...
emailjs.init("1CFHLNapC_EBwg5DZ");
...
const handleSubmit = (e: React.FormEvent) => {
  e.preventDefault();
       ...
       // main email to founder
  const autoReplyID = "template_93jwmjp";   // NEW auto-reply template
   const serviceID = "service_gche6a7";
  const templateID = "template_onurlac";
  const publicKey = "1CFHLNapC_EBwg5DZ";
  ...
  // 1️⃣ SEND EMAIL TO FOUNDER
  emailjs.send(serviceID, templateID, templateParams, publicKey)

    .then(() => {
      // 2️⃣ SEND AUTO-REPLY TO USER
      return emailjs.send(serviceID, autoReplyID, templateParams, publicKey);
    })
